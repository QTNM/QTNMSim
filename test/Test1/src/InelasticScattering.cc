#include "InelasticScatteringList.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(InelasticScatteringList);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

InelasticScatteringList::InelasticScatteringList(G4int ver, const G4String &)
    : G4VPhysicsConstructor("InelasticScattering"), verbose(ver) {
...
InelasticScatteringList::~InelasticScatteringList() = default;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void InelasticScatteringList::ConstructParticle() {
...
void InelasticScatteringList::ConstructProcess() {
  if (verbose > 1) {
