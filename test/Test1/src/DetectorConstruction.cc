...
void DetectorConstruction::DefineMaterials()
{
  ...
  G4Material *HMat = new G4Material("HydrogenGas", 1e-4 * g / cm3, 1);
  HMat->AddElement(H, 1);

  G4Element *D = new G4Element("Deuterium", "D", 1., 2.0141 * g / mole);
  G4Material *DMat = new G4Material("DeuteriumGas", 1e0 * g / cm3, 1);
  DMat->AddElement(D, 1);

  G4Element *T = new G4Element("Tritium", "T", 1., 3.016 * g / mole);
  G4Material *TMat = new G4Material("TritiumGas", 1e0 * g / cm3, 1);
  TMat->AddElement(T, 1);

  G4Element *He = new G4Element("Helium", "He", 2., 4.003 * g / mole);
  G4Material *HeMat = new G4Material("HeliumGas", 1e0 * g / cm3, 1);
  HeMat->AddElement(He, 1);

  G4Element *Ar = new G4Element("Argon", "Ar", 18., 39.948 * g / mole);
  G4Material *ArMat = new G4Material("ArgonGas", 1e0 * g / cm3, 1);
