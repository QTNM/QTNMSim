#include "ElasticScatteringList.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(ElasticScatteringList);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

ElasticScatteringList::ElasticScatteringList(G4int ver, const G4String &)
    : G4VPhysicsConstructor("ElasticScattering"), verbose(ver) {
...
ElasticScatteringList::~ElasticScatteringList() = default;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void ElasticScatteringList::ConstructParticle() {
...
void ElasticScatteringList::ConstructProcess() {
  if (verbose > 1) {
