...
// ********************************************************************
//
// from G4UniformElectricField
//
// Class description:
//
// Class for creation of Uniform Magnetic Field allowing for Larmor losses.

// Created: V.Grichine, 30.01.1997
// -------------------------------------------------------------------
#ifndef QTUNIFORMLARMORFIELD_HH
#define QTUNIFORMLARMORFIELD_HH

#include "G4Types.hh"
#include "G4ThreeVector.hh"
#include "QTLarmorEMField.hh"

class QTLarmorUniField : public QTLarmorEMField
{
  public:
   ...
   ~QTLarmorUniField() override;
    ...
    void SetFieldValue(const G4ThreeVector& newField);
