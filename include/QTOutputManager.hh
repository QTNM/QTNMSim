...
public:
  ...
  inline void FillSourceTime(G4double val) { stvec.push_back(val); }
...
private:
  ...
  std::vector<G4double>& GetSourceTime()   { return stvec; }
  ...
  std::vector<G4double> kvec;    // Kinetic energy vector
  std::vector<G4double> stvec;   // source time vector
